...
{ledger_witness}
      ...
      - name: Append ledger row and push
        run: |
          ...
          # --autostash: the engine build regenerates tsc_engine.opam in
          # the working tree, and a plain rebase refuses a dirty tree —
          # runs 10 and 11 each computed a full hybrid measurement and
          # lost it exactly here.
