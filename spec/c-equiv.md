...
2. **One-as-two** — the atom: unity-as-duality, the fundamental articulation
3. **Three positions** — tri(·,·,·): minimal structure to hold one-as-two
4. **c(0)** — the base atom (cohering as one-as-two)
5. **c(n)** — successive articulation: the atom iterating
6. **c(n,m)** — nested articulation: the atom within the atom
7. **Embedding 𝘑** — formal encoding via H (iteration) and V (nesting)
8. **Terms T** — e (wholeness), a (atom), tri (three positions holding atom)
...
13. **Scores s_i** — measuring coherence; wholeness (no atoms) is maximal (score 1)
14. **Aggregate C_Σ** — overall coherence requires all three measurements; disruption-antitone
