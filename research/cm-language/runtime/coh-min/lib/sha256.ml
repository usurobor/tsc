(* Pure-OCaml SHA-256 (FIPS 180-4). No external dependencies.
   ...
   This is the Sub-3 runtime's OWN in-tree copy (isolated: it does NOT link
   the Sub-1 fixture generator). The oracle step uses it to recompute the
   sealed-reveal content digest and check it binds the public commitment.

   Rationale: the runtime must emit *real*, independently
