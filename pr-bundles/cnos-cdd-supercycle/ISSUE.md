# cdd: Incorporate supercycle learnings — honest-claim review, MCA preconditions, docs-only disconnect, round metrics, honest-grading rubric

**Labels:** `docs, P2, cdd`
**Priority:** P2 — protocol-coherence improvement; the supercycle exposed five recurring patterns the cdd skills did not yet address.
**Status:** Patches authored; ready for cycle dispatch.
**Mode:** docs-only (no code, no version bump; per `cdd/release/SKILL.md` §2.5b proposed in this issue).
...
**What is expected:** The supercycle surfaced five recurring patterns the existing skills don't yet address:
...
- `cdd/post-release/SKILL.md`: expand §4 with per-cycle round counts table + 5-class finding taxonomy; update Step 2 ledger row format.
